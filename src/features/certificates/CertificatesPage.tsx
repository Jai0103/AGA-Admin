  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <SummaryCard label="Active Templates" value={String(summary.activeTemplates)} icon={FileText} tone="blue" />
        <SummaryCard label="Ready To Generate" value={String(summary.ready)} icon={BadgeCheck} tone="emerald" />
        <SummaryCard label="Generated PDFs" value={String(summary.generated)} icon={ShieldCheck} tone="coral" />
        <SummaryCard label="Issued" value={String(summary.issued)} icon={QrCode} tone="amber" />
      </section>
        ...
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
              The preview uses your actual certificate background image with
              dynamic certificate fields placed on top.
            </p>
          </div>
