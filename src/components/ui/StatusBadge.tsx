...
const statusClasses = {
  ...
  Eligible: "bg-emerald-100 text-emerald-700 dark:bg-emerald-400/15 dark:text-emerald-200",
  ...
  "Not Tracked": "bg-slate-200 text-slate-700 dark:bg-white/10 dark:text-slate-200",
  ...
  "Not Required": "bg-slate-200 text-slate-700 dark:bg-white/10 dark:text-slate-200",
